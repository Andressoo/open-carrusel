...
export const BLUEPRINT = [
...

  {
    ...
    reel: { template: "Contrast", hook: "14 feb NO", body: "4000 competidores. Tu fecha es otra. 1 oct café. 1 sep gym. Menos ruido, más conversión.", cta: "Comentá FECHA.", why: "Contraste conceptual." },
